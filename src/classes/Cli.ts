...
class Cli {
  ...
  createCar(): void {
    inquirer
      ...
      .then((answers) => {
        const car = new Car(
          // The generateVin method is static and should be called using the class name Cli, make sure to use Cli.generateVin() for creating a truck and motorcycle as well!
          Cli.generateVin(),
          answers.color,
          answers.make,
          answers.model,
